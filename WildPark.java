...
public class WildPark extends Application {
    ...
    final Background BACKGROUND_MOUNTAIN_DARK = new Background( new BackgroundFill( Paint.valueOf( "linear-gradient(from 0px 54px to 0px 0px, #808080 20%, 0x80808055 100%)" ), new CornerRadii( 5 ), new Insets(1,1,0,0) ) );
