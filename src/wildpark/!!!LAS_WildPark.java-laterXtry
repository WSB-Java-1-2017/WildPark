...
public class WildPark extends Application {
    ...
    final int WILD_PARK_FOREST_AVERAGE_WIDTH = 20;
    final int WILD_PARK_FOREST_HEIGHT = 35;
    ...
    final Background BACKGROUND_FOREST_GREEN = new Background( new BackgroundFill( Paint.valueOf( "linear-gradient(from 0px 54px to 0px 0px, #ee15a4 20%, 0xee16a422 100%)" ), new CornerRadii( 5 ), new Insets(1,1,0,0) ) );
...
// scrollPane.viewportBoundsProperty());
    ...
    void newWildParkArea() {
        ...
        int previousForestLeftRandom = WILD_PARK_FOREST_AVERAGE_WIDTH + (int)(0.55*WILD_PARK_AREA_WIDTH);
        int previousForestRightRandom = previousForestLeftRandom + random.nextInt( WILD_PARK_FOREST_AVERAGE_WIDTH );
        ...
        for( int y=0; y<WILD_PARK_AREA_HEIGHT; y++ ) {
            ...
            if( y==9 ) currentForestRightRandom = currentForestLeftRandom+4;
            if( y==10 ) currentForestRightRandom = currentForestLeftRandom+7;
            if( y==8+WILD_PARK_FOREST_HEIGHT-2 ) currentForestRightRandom = currentForestLeftRandom+7;
            if( y==8+WILD_PARK_FOREST_HEIGHT-1 ) currentForestRightRandom = currentForestLeftRandom+4;
...
//              areaCell.setBackground( Background.EMPTY );
                ...
                if( x>currentForestLeftRandom && x<currentForestRightRandom && y>9 && y<8+WILD_PARK_FOREST_HEIGHT ) {
