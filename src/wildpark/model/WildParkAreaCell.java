...
public class WildParkAreaCell extends Button {
	...
	/**
	 * LinkedHashSet is used because we want to know the sequence of animals arrival
	 * to particular WildParkAreaCell and we will often add or remove animals from
	 * inside the set - LinkedHashSet assures O(1).
	 */
	...
	/**
	 * This method removes the Tooltip Delay - using it will show tootip
	 * imediatelly.
	 * 
	 * @param node
	 *            [description]
	...
	public void update() {
		...
		// System.out.println( "WildParkAreaCell.update() - animals.size() BEFORE = " +
		// animals.size() );
		// for( Animal animal : rottenAnimalBodies ) {
		// animals.remove( animal );
		// }
		// System.out.println( "WildParkAreaCell.update() - animals.size() AFTER = " +
		// animals.size() );
