 ...
 */
public class Dolphin extends Mammals implements Predator, DivingAnimal, SwallowingAnimal, DiurnalAnimal  {
	...
	public Dolphin( AnimalSpeciesSpecification animalSpeciesSpecification, WildParkAreaCell wildParkAreaCell, boolean isNewborn ) {
	...
	public boolean isDiurnal() {
		return false; //isActiveDuringDay
	}
