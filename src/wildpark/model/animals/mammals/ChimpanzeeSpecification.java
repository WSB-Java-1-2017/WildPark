 ...
 */
public final class ChimpanzeeSpecification extends AnimalSpeciesSpecification {
	private final String NAME = "Chimpanzee";
	private final float ADULT_WEIGHT = 55;	// weight in kg 
	private final float NEWBORN_WEIGHT = 2; // in kg
	private final float FOOD_QUANTITY_REQUIRED_PER_DAY = 4; // in kg
	...
	private final int MAX_SPEED = 3;	// km/h
	...
	private final Duration MIN_BREEDING_AGE = Duration.ofDays(46*30); // minimalny wiek rozrodczy
	private final Duration MAX_BREEDING_AGE = Duration.ofDays(30*365); // maksymalny wiek rozrodczy
	private final Duration MAX_AGE_IN_NEST = Duration.ofDays(6*30); // po ilu 
	private final Duration MIN_SELF_GOVERNMENT_AGE = Duration.ofDays(8*30); // minimalny wiek usamodzielnienia się
