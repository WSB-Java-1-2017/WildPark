 ...
 */
	...
	private final int HUNGER_ENERGY_PERCENT = 70; // poni�ej tej warto�ci zwierze poszukuje jedzenia. Powy�ej zwierze nie jest zainteresowane jedzeniem 
	private final float STANDARD_SPEED = 9;	// km/h, sprawdzamy jak� odleg�o�� zwierz� standardowo pokonuje w ci�gu dnia (w czasie godzin aktywno�ci) i na tej podstawie obliczamy stardard w km/h
	private final int MAX_SPEED = 80;	// km/h
	private final int MAX_STAMINA = 100; 	//
	private final int AVERAGE_SCION_COUNT_IN_LITTER = 2; // �rednia liczba potomk�w w miocie
	private final int MAX_SCION_COUNT_IN_LITTER = 4;	// na tej podstawie okre�limy wide�ki RANDOMa okre�laj�cego liczb� potomk�w w danym miocie
	...
	private final Duration MIN_SELF_GOVERNMENT_AGE = Duration.ofDays(16*30); // minimalny wiek usamodzielnienia si�
