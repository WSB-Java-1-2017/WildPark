 ...
 */
public final class EagleSpecification extends AnimalSpeciesSpecification {
//
	private static final String SPECIES_NAME = "Eagle";
	private static final float ADULT_WEIGHT = 5.0f;	// weight in kg 
	private static final float NEWBORN_WEIGHT = 0.01f; // in kg
	private static final float FOOD_QUANTITY_REQUIRED_PER_DAYS = 0.2f; // in kg
	...
	private static final float STANDARD_SPEED = 10.0f;	// km/h, sprawdzamy jaką odległość zwierzę standardowo pokonuje w ciągu dnia (w czasie godzin aktywności) i na tej podstawie obliczamy stardard w km/h
	private static final int MAX_SPEED = 160;	// km/h
	...
	private static final Duration MAX_AGE = Duration.ofDays(30*365); // 20 years
	private static final Duration MIN_BREEDING_AGE = Duration.ofDays(3*30); // minimalny wiek rozrodczy
	private static final Duration MAX_BREEDING_AGE = Duration.ofDays(25*365); // maksymalny wiek rozrodczy
	...
	private static int CALORIC_EFFICIENCY_PER_KILO = 1920; // Cal/kg
