...
public class WildParkArea {
	...
	/**
	 * Get the list of animals that died in current Wild Park Time Step. Those
	 * animals must be removed from animals list and added to dead bodies list. This
	 * list is required to avoid concurrency problems wile making a time step in
	 * Wild Park in .
	 * 
