...
public class Diagram01 {
	...
	public void init() { // Stage stage
		...
		/*
		 * Button step = new Button("next step"); step.setOnAction(new
		 * EventHandler<ActionEvent>() {
		 * 
		 * @Override public void handle(ActionEvent event) { nextStep(); } });
		 */
		/*
		 ...
		 * 
		 * series1.setName("Horse"); series2.setName("Insect Eating Bat");
		 * series3.setName("Giraffe"); series4.setName("Mammal4");
		 * series5.setName("Mammal5");
		 */

		// Scene scene = new Scene( new BorderPane( lineChart, step, null, null, null ),
		// 800,600 );
